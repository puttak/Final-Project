...
plt.legend(['Activated Sludge Biomass', 'Particulate Substrate', 'Soluble Substrate','Acidogenic Biomass','Volatile fatty acid','Methanogens','Methane'], loc='upper right')
#pl.title('\n' + '\n' + 'Anaerobic Treatment Of Sludge Conc Profiles \n'+ '\n'+'Blue = Activated Sludge Biomass, Green = Particulate Substrate, Green = Methane''\n'+'Red=Soluble Substrate''\n'+')
